package com.login.authserver.services;
...
// The JWT has three portions as follows:
// - Header - For agreeing on the algorithm for signing the message.
// - Payload - For carrying user data.
// - Signature - For Verification

// The payload of this token includes three things:
// - User ID (subject)
// - Role (audience)
// - Token Expiry Time (expiry)

public class JwtUtil {
	private static final String SECRET_KEY = "SHE_SELLS_SEA_SHELLS";
	...
	public JwtUtil(String sub, JSONArray aud, long expires) {
		this();
		payload.put("sub", sub);
		payload.put("aud", aud);
